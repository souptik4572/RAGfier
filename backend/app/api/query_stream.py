...
from app.api.rate_limit import enforce_jwt_stream_limits, release_stream_limit_lease
...
async def query_stream(
    ...
    stream_lease, rate_limit_headers = await enforce_jwt_stream_limits(auth)
